Create a minimal structued API for booking laundry sessions at SSSB that wraps their Aptus Portal laundry booking service.
...
- Authentication should consist of only supplying the object id to each request, the underlying sessions should be reused and reauthenticated if expired.
